...
import { HTMLParse, getHTMLString, isValidHTML, isValidMWBSchedule, isValidWSchedule } from './html_validation.ts';

export const extractEPUBFiles = async (data: ArrayBuffer | Uint8Array | Buffer | Blob | Promise<any>) => {
...
export const validateEPUBContents = async (data: ArrayBuffer | Uint8Array | Buffer | Blob | Promise<any>) => {
	const MAX_FILES = 300;
