import { JWEPUBParserError } from '../classes/error.ts';
import { getMonthNames, getPartMinutesSeparatorVariations, getStudyArticleDateVariations } from './language_rules.ts';
